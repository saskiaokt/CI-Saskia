  ...
  <div class="wrapper">
    <header class="main-header">
      ...
      <a href="<?= base_url('admin') ?>" class="logo">
        ...
        <span class="logo-mini"><img src="<?= base_url() ?>/gambar_profil_website/<?= $website['logo'] ?>" width="30px" alt=""></span>
        <!-- logo for regular state and mobile devices -->
        <span class="logo-lg"><img src="<?= base_url() ?>/gambar_profil_website/<?= $website['logo'] ?>" width="30px" alt=""> <b><?= $website['nama_website'] ?></b></span>
      </a>
